...
public class LearningRegexCharacterClasses {
	...
	public static void main(String[] args) {
		...
		// Replace all letter a to X
		String replaceString = message.replaceAll("a", "X");
		...
		// Replace g or p to X.
		System.out.println(message.replaceAll("[gp]", "X"));
		...
		// Replace all letters a to k except for c or g
		// in to X.
